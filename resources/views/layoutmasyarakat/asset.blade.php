...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
        <a href="index.html" class="navbar-brand d-flex align-items-center">
            <h2 class="m-0 text-primary"><img class="img-fluid me-2" src="{{ asset('masyarakat/img/icon-1.png') }}" alt=""
        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 animated fadeIn">
                    <img class="img-fluid animated pulse infinite" style="animation-duration: 3s;" src="{{ asset('masyarakat/img/hero-1.png') }}"
                        alt="">
                </div>
            </div>
        </div>
        ...
        <div class="container py-5">
            ...
            <div class="row g-3">
                ...
                <div class="col-12 text-center">
                    <img class="img-fluid m-1" src="{{ asset('masyarakat/img/payment-1.png') }}" alt="" style="width: 50px;">
                    <img class="img-fluid m-1" src="{{ asset('masyarakat/img/payment-2.png') }}" alt="" style="width: 50px;">
                    <img class="img-fluid m-1" src="{{ asset('masyarakat/img/payment-3.png') }}" alt="" style="width: 50px;">
                    <img class="img-fluid m-1" src="{{ asset('masyarakat/img/payment-4.png') }}" alt="" style="width: 50px;">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid bg-light footer mt-5 pt-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-md-6">
                    <h1 class="text-primary mb-4"><img class="img-fluid me-2" src="{{ asset('masyarakat/img/icon-1.png') }}" alt=""
