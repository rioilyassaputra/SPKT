...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  ...
  <div class="row">
    ...
    <div class="col-lg-12">
          ...
          <table class="table align-items-center table-flush" id="dataTable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editkategori"
                    id="#myBtn">
                    edit
                  </button>
      ...
      <div class="modal fade" id="editkategori" tabindex="-1" role="dialog" aria-labelledby="editkategorilabel"
      aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="editkategorilabel">Edit</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form action="{{ route('kategori-laporan.store') }}" method="post">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control @error('nama_kategori_laporan') is-invalid @enderror"  name="nama_kategori_laporan" id="exampleInputEmail1" aria-describedby="emailHelp"
