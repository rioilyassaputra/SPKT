    ...
    <div class="container py-5">
        <div class="row g-5">
            <div class="col-lg-4 col-md-6 text-center wow fadeIn" data-wow-delay="0.1s">
                <img class="img-fluid mb-4" src="{{ asset('masyarakat/img/icon-9.png') }}" alt="">
                <h1 class="display-4" data-toggle="counter-up">123456</h1>
                <p class="fs-5 text-primary mb-0">Today Transactions</p>
            </div>
            <div class="col-lg-4 col-md-6 text-center wow fadeIn" data-wow-delay="0.3s">
                <img class="img-fluid mb-4" src="{{ asset('masyarakat/img/icon-10.png') }}" alt="">
                <h1 class="display-4" data-toggle="counter-up">123456</h1>
                <p class="fs-5 text-primary mb-0">Monthly Transactions</p>
            </div>
            <div class="col-lg-4 col-md-6 text-center wow fadeIn" data-wow-delay="0.5s">
                <img class="img-fluid mb-4" src="{{ asset('masyarakat/img/icon-2.png') }}" alt="">
                <h1 class="display-4" data-toggle="counter-up">123456</h1>
...
<div class="container py-5">
    <div class="row g-5 align-items-center">
        <div class="col-lg-7">
            <h1 class="display-4 mb-3 animated slideInDown">Selamat datang di layanan E-SPKT Polrestabes Semarang.</h1>
            <p class="animated slideInDown">SPKT atau Sentra Pelayanan Kepolisian Terpadu bertugas memberikan pelayanan
                kepolisian kepada masyarakat, dalam bentuk penerimaan dan penanganan pertama laporan/pengaduan,
                pelayanan bantuan/pertolongan kepolisian, bersama fungsi terkait mendatangi TKP untuk melaksanakan
                kegiatan pengamanan dan olah TKP sesuai ketentuan hukum dan peraturan yang berlaku.</p>
            <a href="" class="btn btn-primary py-2 px-4 animated slideInDown">Lapor Sekarang</a>
        </div>
        <div class="col-lg-5 animated fadeIn">
            <img class="img-fluid animated pulse infinite" style="animation-duration: 3s;"
                src="{{ asset('masyarakat/img/hero-1.png') }}" alt="">
        </div>
    </div>
</div>
@endsection
...
@section('features')
    <div class="container">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
            <h1 class="display-6">Syarat Kehilangan</h1>
            <p class="fs-5 mb-5">Syarat laporan kehilangan</p>
        </div>
        <div class="row g-5">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="card card-body shadow h-100">
                    <div class="d-flex align-items-start">
                        {{-- <img class="img-fluid flex-shrink-0" src="{{ asset('masyarakat/img/icon-6.png') }}" alt=""> --}}
                        <div class="ps-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="card card-body shadow h-100">
                    <div class="d-flex align-items-start">
                        {{-- <img class="img-fluid flex-shrink-0" src="{{ asset('masyarakat/img/icon-5.png') }}" alt=""> --}}
                        <div class="ps-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="card card-body shadow h-100">
                    <div class="d-flex align-items-start">
                        {{-- <img class="img-fluid flex-shrink-0" src="{{ asset('masyarakat/img/icon-4.png') }}" alt=""> --}}
                        <div class="ps-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="card card-body shadow h-100">
                    <div class="d-flex align-items-start">
                        {{-- <img class="img-fluid flex-shrink-0" src="{{ asset('masyarakat/img/icon-3.png') }}" alt=""> --}}
                        <div class="ps-4">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="card card-body shadow h-100">
                    <div class="d-flex align-items-start">
                        {{-- <img class="img-fluid flex-shrink-0" src="{{ asset('masyarakat/img/icon-8.png') }}" alt=""> --}}
                        <div class="ps-4">
        ...
        <div class="row g-4">
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item bg-white p-5">
                    <img class="img-fluid mb-4" src="{{ asset('masyarakat/img/icon-7.png') }}" alt="">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item bg-white p-5">
                    <img class="img-fluid mb-4" src="{{ asset('masyarakat/img/icon-3.png') }}" alt="">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item bg-white p-5">
                    <img class="img-fluid mb-4" src="{{ asset('masyarakat/img/icon-5.png') }}" alt="">
            ...
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item bg-white p-5">
                    <img class="img-fluid mb-4" src="{{ asset('masyarakat/img/icon-8.png') }}" alt="">
    ...
    <div class="container py-5">
        ...
        <div class="row g-3">
            ...
            <div class="col-12 text-center">
                <img class="img-fluid m-1" src="{{ asset('masyarakat/img/payment-1.png') }}" alt=""
                    style="width: 50px;">
                <img class="img-fluid m-1" src="{{ asset('masyarakat/img/payment-2.png') }}" alt=""
                    style="width: 50px;">
                <img class="img-fluid m-1" src="{{ asset('masyarakat/img/payment-3.png') }}" alt=""
                    style="width: 50px;">
                <img class="img-fluid m-1" src="{{ asset('masyarakat/img/payment-4.png') }}" alt=""
                    style="width: 50px;">
            </div>
        </div>
    </div>
...
@section('footer')
    <div class="container py-5">
        <div class="row g-5">
            {{-- <div class="col-md-6">
                <h1 class="text-primary mb-4"><img class="img-fluid me-2" src="{{ asset('masyarakat/img/icon-1.png') }}"
